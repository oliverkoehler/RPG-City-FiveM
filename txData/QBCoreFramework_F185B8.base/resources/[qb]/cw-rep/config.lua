...
Config.HideSkillsWithZeroLevels = false -- Hide skills from the menu if you aren't on level 1
...
Config.Skills = {
    busJob = {
        ...
        icon = 'fas fa-bus',
        skillLevels = {
            { title = "Lehrling", from = 0, to = 20 },
            { title = "Busfahrer", from = 20, to = 50 },
            { title = "Tourguide", from = 50, to = 100 },
            { title = "Ausbilder", from = 100, to = 200 },
            { title = "Manager", from = 200, to = 500 }
        }
    },
    -- househeft = {
    --     label = 'House Theft',
